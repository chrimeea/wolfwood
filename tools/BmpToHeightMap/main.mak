...
LINK32=link.exe
LINK32_FLAGS=corona.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\main.pdb" /machine:I386 /out:"$(OUTDIR)\main.exe" 
LINK32_OBJS= \
	"$(INTDIR)\main.obj"
...
LINK32=link.exe
LINK32_FLAGS=corona.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\main.pdb" /debug /machine:I386 /out:"$(OUTDIR)\main.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\main.obj"
